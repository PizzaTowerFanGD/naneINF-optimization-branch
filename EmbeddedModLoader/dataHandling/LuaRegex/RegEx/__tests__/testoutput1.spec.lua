return function()
	--local testData = require("src/LuaRegex/RegEx/__tests__/testoutput1.gen")
	--local escapeString = require("src/LuaRegex/RegEx/__tests__/escapeString")
	local RegEx = require("LuaRegex/RegEx/init")
